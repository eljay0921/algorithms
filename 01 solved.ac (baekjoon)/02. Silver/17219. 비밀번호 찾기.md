...
| :-------- | :---------- | :---- | :---- | :-------- | :-------- |
| 5 초      | 256 MB      | 35097 | 24888 | 21128     | 71.720%   |
...
Silver 치고는 쉽게 풀렸다. 알고리즘 측면에서 고민할 부분이 없었다. 적절한 자료구조(`HashMap<>`)의 사용을 보는 문제로 보인다. 시간은 `508ms`로 꽤 걸렸으나, 다른 사람들의 제출을 보니 느린 편은 아니다. 애초에 `key`로 사용할 값이 `String`이라 더 빠르게 처리하긴 어려울 것으로 보인다. ([결과](https://www.acmicpc.net/source/96346348))
